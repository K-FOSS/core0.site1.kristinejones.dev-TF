job "registry-harbor-core" {
  ...
  group "harbor-core-redis" {
    ...
    service {
      ...
      task = "harbor-core-cache"
      address_mode = "alloc"

      tags = ["coredns.enabled", "redis.core"]
  ...
  group "harbor-registry-core-server" {
    ...
    task "harbor-core-server" {
      ...
      env {
        ...
        REGISTRY_CONTROLLER_URL = "https://https.registrycontroller.harbor.service.dc1.kjdev:9443"
