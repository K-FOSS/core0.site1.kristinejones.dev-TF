job "registry-harbor-gitlab-registry" {
  ...
  group "harbor-registry-registry" {
    ...
    service {
      ...
      tags = ["coredns.enabled", "https.gitlabregistry"]
    }
    ...
    service {
      ...
      tags = ["coredns.enabled", "metrics.gitlabregistry"]
    }
...
EOH
    ...
    service {
      ...
      tags = ["coredns.enabled", "https.gitlabregistrycontroller"]
    }
